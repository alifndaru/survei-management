                        ...
                        <form action="{{ route('acp.update', $question->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($options as $option)
                                <div class="option-group">
                                    <textarea name="option_url[]" class="form-control mb-2 option-input" placeholder="Enter Option URL">{{ old('option_url.' . $loop->index, $option->option_url ?? '') }}</textarea>
                                    @if ($errors->has('option_url.' . $loop->index))
                                        <span class="help-block">{{ $errors->first('option_url.' . $loop->index) }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('option_description.' . $loop->index))
                                        <span
                                            class="help-block">{{ $errors->first('option_description.' . $loop->index) }}</span>
                                    @endif
