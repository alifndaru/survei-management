...
class SkalaStressController extends Controller
{
    public function index()
    {
        $questions = Questions::with('options')->where('category_id', 3)->orderBy('created_at', 'desc')->paginate(10);
        return view('dashboard.skala-stress.index', compact('questions'));
    }
    public function create()
    {
        $categories = Category::all();
        return view('dashboard.skala-stress.create', compact('categories'));
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('skala-stress.create')->with('success', 'Pertanyaan dan opsi berhasil disimpan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.skala-stress.edit', compact('question', 'categories', 'options'));
    }
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('skala-stress.edit', $question->id)->with('success', 'Pertanyaan berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            $question->delete();
            return redirect()->route('skala-stress.index')->with('success', 'Pertanyaan berhasil dihapus.');
        } catch (\Exception $e) {
            // Log the error or return an error message
            return redirect()->route('skala-stress.index')->with('error', 'Error deleting question: ' . $e->getMessage());
        }
    }
}
